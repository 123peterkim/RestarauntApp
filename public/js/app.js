...
window.angular.module('ngff.controllers', ['ngff.controllers.header','ngff.controllers.index', 'ngff.controllers.restaurant-add', 'ngff.controllers.users', 'ngff.controllers.order', 'ngff.controllers.vote']);
